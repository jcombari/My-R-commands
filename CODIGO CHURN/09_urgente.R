...
modelo_randomForest11<-randomForest(TARGET_objetivo ~., data=down_training,  mtry = 10, ntree = 100,
...
modelo_randomForest12<-randomForest(TARGET2_objetivo ~., data=down_training2,  mtry = 10, ntree = 100,
                                    importance = TRUE, nodesize = 1 )
...
modelo_randomForest11<-randomForest(TARGET_objetivo ~., data=smote_training,  mtry = 10, ntree = 100,
                                    importance = TRUE, nodesize = 1 )
gc()
...
modelo_randomForest12<-randomForest(TARGET2_objetivo ~., data=smote_training2,  mtry = 10, ntree = 100,
                                    importance = TRUE, nodesize = 1 )
